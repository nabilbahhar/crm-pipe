      ...
      <div className="mx-auto max-w-[1500px] px-4 py-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          <div className="rounded-2xl bg-white ring-1 ring-slate-200 shadow-sm p-4">
            ...
            <div className="text-xl font-black text-slate-900 mt-1">{kpis.total}</div>
          </div>
          <div className="rounded-2xl bg-white ring-1 ring-slate-200 shadow-sm p-4">
            <div className="text-[10px] font-bold uppercase tracking-widest text-red-400">Expirant &lt; 30j</div>
            <div className="text-xl font-black text-red-600 mt-1">{kpis.within30}</div>
          </div>
          <div className="rounded-2xl bg-white ring-1 ring-slate-200 shadow-sm p-4">
            <div className="text-[10px] font-bold uppercase tracking-widest text-orange-400">Expirant &lt; 90j</div>
            <div className="text-xl font-black text-orange-600 mt-1">{kpis.within90}</div>
          </div>
          <div className="rounded-2xl bg-white ring-1 ring-slate-200 shadow-sm p-4">
            <div className="text-[10px] font-bold uppercase tracking-widest text-red-400">Expirés</div>
            <div className="text-xl font-black text-red-600 mt-1">{kpis.expired}</div>
          </div>
        </div>
